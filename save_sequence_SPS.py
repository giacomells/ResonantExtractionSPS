...
# IMPORTING ALL THE MAGNETS AND ELEMENTS OF THE ACCELERATOR WITH THEY RESPECTIVE STRENGTHS 
# SO THAT RESONANT EXTRACTION CAN BE SIMULATED 
mad.input("""
extr_bump_knob = 0;
...
# Prepare rf cavities for resonant extraction
line.vv['v200'] = 0.
...
# saving the line for later use in the resonant extraction simulation
